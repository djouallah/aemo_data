...
(
  WITH xxxx AS (
    SELECT
      concat('abfss://$ws@$storage_account.dfs.fabric.microsoft.com/$lh.Lakehouse/Files/', extracted_filepath) AS file
    FROM 'abfss://$ws@$storage_account.dfs.fabric.microsoft.com/$lh.Lakehouse/Files/Reports/Current/DispatchIS_Reports/download_log.csv'
