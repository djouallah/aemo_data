...
def scrapingv3(urls: List[str], folders: List[str], totalfiles: int,storage_account: str, ws: str, lh: str, max_workers: int, flush_interval: int = 70) -> int:
    """
    ...
    """
    store = from_url(f'abfss://{ws}@{storage_account}.dfs.fabric.microsoft.com/{lh}.Lakehouse/Files')
    summary = []
